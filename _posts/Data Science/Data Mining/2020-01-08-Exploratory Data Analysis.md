...
| 속성 개수 | 타입 | 방법 |
|---------|-------|--------------------------|
| 단일 속성 | 연속형 | * Boxplot을 통한 사분위수 분석 <br> * Histogram으로 빈도수 분석 <br> * Index plot을 통해 속성의 위치 분석 |
| | 명목형 | * Pie chart <br> * Bar plot |
| 두개 속성 | 연속형 2개 | * 각각의 속성을 x축, y축으로 하여 도해 후 회귀선 표시 <br> * 공분산, 상관계수를 토앻 두 속성간의 관계정도 파악 <br> * Jitter, Sunflower plot (오버랩된 많은 점 표현) |
| | 연속형, 명목형 | * 명목형 속성별 수치 분포(Box plot) 파악<br> * Box plot에 유의수준 추가(노치) <br> * Y축의 scale을 log로한 Strip chart <br> * 막대그래프에 신뢰구간 추가 <br> * 막대그래프에 색상 표현 |
| | 명목형 2개 | Table 함수 |
| 세개 속성 | 연속형 3개 | * 세개 속성 3차원 표현 <br> * 버블 도표 <br> * 산점도에 점의 속성을 표현하여 도해 |
| | 연속형 2개 명목형 1개 | * 문자열 도표로 표현 <br> * 연속형 속성을 도해하되 명목형은 점 모형으로 표현 <br> * 산포도에 점들 간의 관계 표현 <br> * 점과 문자열을 동시 표현 |
|다수의 속성 | | * 다중 패널 레이아웃 <br> * 개체의 변화 파악 <br> * 여러 속성 쌍의 관계 파악 |

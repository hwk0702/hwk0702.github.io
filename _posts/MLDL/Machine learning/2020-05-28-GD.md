...
$$\triangledown_{\theta}{MSE}= \begin{pmatrix} \frac{\delta}{\delta\theta_{0}}{MSE}(\theta) \\ \frac{\delta}{\delta\theta_{1}}{MSE}(\theta) \\ \vdots \\ \frac{\delta}{\delta\theta_{n}}{MSE}(\theta) \end{pmatrix} = \frac{2}{m}\mathbf{x}^{\tau}(\mathbf{x}\theta-y)$$
